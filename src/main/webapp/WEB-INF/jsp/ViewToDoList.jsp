...
<body>
    ...
    <script th:inline="javascript">
                window.onload = function() {
                    ...
                    if (msg == "Item was saved successfully") {
        				Command: toastr["success"]("Item added successfully!!")
        			} else if (msg == "Item deleted successfully") {
        				Command: toastr["success"]("Item deleted successfully!!")
        			} else if (msg == "Item was not deleted successfully") {
        			    Command: toastr["error"]("Some error occurred, couldn't delete item")
        			} else if (msg == "Item was edited successfully") {
